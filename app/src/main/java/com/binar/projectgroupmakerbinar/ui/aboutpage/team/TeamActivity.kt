...
class TeamActivity : AppCompatActivity() {
    ...
    private val teamsApp = listOf(
        ...
        teams("Eri Samsudin" , "Developer",  "I'm Eri Samsudin, currently i learning android programming at Binar Academy. In this chapter, i have project with my group to make a application about Group Maker","https://firebasestorage.googleapis.com/v0/b/latihan-e23ac.appspot.com/o/02.jpg?alt=media&token=fd3f91d4-427a-432a-b0c6-a4585b8f334c") ,
